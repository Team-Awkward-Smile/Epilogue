...
public partial class AudioPlayer : ActorAudioPlayer
{
	...
	protected override Dictionary<string, AudioStream> CollisionSfxList { get; set; } = new()
	{
		...
		{ "LandRock_01", GD.Load<AudioStream>($"{PATH}//collision//land//rock/RockLand1.mp3") },
		{ "LandRock_02", GD.Load<AudioStream>($"{PATH}//collision//land//rock/RockLand1.mp3") },
		{ "LandRock_03", GD.Load<AudioStream>($"{PATH}//collision//land//rock/RockLand1.mp3") },
		{ "LandRock_04", GD.Load<AudioStream>($"{PATH}//collision//land//rock/RockLand1.mp3") },
		...
		{ "RollRock_01", GD.Load<AudioStream>($"{PATH}//collision//roll//rock//RockRoll1.wav") },
		{ "RollRock_02", GD.Load<AudioStream>($"{PATH}//collision//roll//rock//RockRoll2.wav") },
		{ "RollRock_03", GD.Load<AudioStream>($"{PATH}//collision//roll//rock//RockRoll3.wav") },
		{ "RollRock_04", GD.Load<AudioStream>($"{PATH}//collision//roll//rock//RockRoll4.wav") },
	};
