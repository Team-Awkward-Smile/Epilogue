...
{
	[Export] private float _cameraMovementDelay = 1f;
	...
	public override void Update(double delta)
	{
		...
		if(_timer > _cameraMovementDelay && !_isCameraMoving)
		{
			...
			_raiseCameraTween.TweenProperty(_cameraAnchor, "position", new Vector2(_cameraAnchor.Position.X, _cameraAnchor.Position.Y - 100), 0.5f);
		}
	}
